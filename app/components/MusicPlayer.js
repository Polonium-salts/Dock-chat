...
export default function MusicPlayer({ onLyricsChange }) {
  ...
  return (
    <div className="h-full flex bg-white">
      ...
      <div className="w-80 flex-none flex flex-col border-r border-gray-100">
        {/* Now Playing */}
        <div className="flex-1 p-4 overflow-hidden">
          <div className="h-full flex flex-col">
            {currentTrack ? (
              <div className="space-y-4 flex-none">
                <div className="relative aspect-square w-full rounded-2xl overflow-hidden shadow-lg group">
                  {currentTrack.cover ? (
                    <img
                ...
                <div className="space-y-1 px-1">
                  <input
                    ...
                    className="w-full h-1 bg-gray-100 rounded-full appearance-none cursor-pointer accent-purple-600"
                  />
                ...
                <div className="flex items-center justify-between px-4">
                  ...
                  <button
                    ...
                    className="p-3 text-white bg-purple-600 rounded-full hover:bg-purple-700 shadow-lg"
                  >
                    {isPlaying ? (
                ...
                <div className="flex items-center space-x-2 px-1">
                  ...
                  <input
                    ...
                    className="flex-1 h-1 bg-gray-100 rounded-full appearance-none cursor-pointer accent-purple-600"
                  />
                </div>
              </div>
            ) : (
        ...
        {/* Lyrics Panel */}
        {currentLyrics.lrc && (
          <div className="flex-none h-32 p-2 border-t border-gray-100">
          ...
          {!musicSource ? (
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:bg-white"
              />
              ...
              <div className="divide-y divide-gray-100">
                {playlist.map((track) => (
                  <button
                    ...
                    className={`w-full px-4 py-2.5 flex items-center space-x-3 hover:bg-gray-50 transition-colors ${
