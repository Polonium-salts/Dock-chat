        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 border border-gray-700">
            <div className="p-6">
              ...
              <p className="text-gray-300">Connect with others instantly through our real-time messaging platform.</p>
            </div>
          </div>
          ...
          <div className="bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 border border-gray-700">
            <div className="p-6">
              <div className="w-10 h-10 bg-orange-900 rounded-full flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 5c7.18 0 13 5.82 13 13M6 11a7 7 0 017 7m-6 0a1 1 0 11-2 0 1 1 0 012 0z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">RSS Integration</h3>
              <p className="text-gray-300">Stay updated with your favorite content through RSS feed integration.</p>
            </div>
          </div>
          ...
          <div className="bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 border border-gray-700">
            <div className="p-6">
              <div className="w-10 h-10 bg-green-900 rounded-full flex items-center justify-center mb-4">
              ...
              <p className="text-gray-300">Simple and secure authentication with GitHub or test account.</p>
            </div>
          </div>
        </div>
      </div>
